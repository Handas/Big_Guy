	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			...
			if ( 1 === $comments_number ) {
				...
				printf( _x( 'One Kommentar für &ldquo;%s&rdquo;', 'comments title', 'oblique' ), '<span>' . get_the_title() . '</span>' );
			} else {
				printf(
					/* translators: 1: number of comments, 2: post title */
					_nx(
						'%1$s Kommentar für &ldquo;%2$s&rdquo;',
						'%1$s Kommentare für &ldquo;%2$s&rdquo;',
						$comments_number,
						'comments title',
						'oblique'
					),
